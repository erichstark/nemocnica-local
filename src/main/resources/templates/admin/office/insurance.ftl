...
<#assign pageTitle>Editácia poisťovní</#assign>
...
<div class="table-responsive" id="form">
    ...
    <div class="form-group">
                ...
                <tr id="insurance-${insurance.id}">
                    ...
                    <td class="text-center">
                        <button name="submit" class="btn btn-sm btn-danger"
                                onclick="removeInsurances(${insurance.id})">
        ...
        <h4 id="no-insurance"
            <#if office.insurances?has_content>style="display: none"</#if>class="text-muted">
            Ambulancia nemá priradené žiadne poisťovne.</h4>
    </div>
...
<script src="<@spring.url '/js/admin/officeInsurance.js'/>"></script>
</@pt.dashboardPage>