...
<div class="panel-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-info btn-sm" href="<@spring.url '/'/>" role="button">Naspäť</a>
            &nbsp;&nbsp;
            <a class="btn btn-info btn-sm" target=“_blank” href="<@spring.url '/office/${office.id}/orders'/>"
               role="button">Objednaný pacienti</a>
            <a style="float: right" class="btn btn-info btn-sm" target=“_blank”
               href="<@spring.url '/office/${office.id}/call'/>" role="button">Vyvolávanie pacientov</a>
        </div>
    </div>
    <hr>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody id="employees">
                ...
                <tr id="employee-${employee.username}">
                    ...
                    <td style="text-align: left">${employee.prefix_title!""} ${employee.firstName!""} ${employee.lastName!""} ${employee.suffix_title!""}</td>
                </tr>
                </#list>
            </tbody>
        </table>
